...
const CourseDetails = () => {
  const { purposefulprograms, videoModal } = useContext(AppContext)

  return (
    <div className='courseDetails'>
      {/* left col containing video img and tabbed components */}
      <CourseDetailsLeftCol currCourse={purposefulprograms} />

      {/* text component */}
      <CourseDetailsText currCourse={purposefulprograms} />
