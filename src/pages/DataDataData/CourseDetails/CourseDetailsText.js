  ...
  return (
    <div className='courseDetailsText'>
      ...
      <div className='courseDesc'>
        ...
        <ul className='courseDescList active'>
          {currCourse.courseDesc.courseDescListItems.map((item, i) => {
            return (
      ...
      <h2 className='courseDescNote'>Note:</h2>
      <p className='courseDescNoteText'>{currCourse.courseDesc.note}</p>
